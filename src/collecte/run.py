"""Point d'entrée : collecte Open-Meteo 3 fois par jour.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--force",
        action="store_true",
        help="ignore le filtre 7h / 13h / 19h (Europe/Paris)",
    )
    parser.add_argument(
        "--model",
        action="append",
...
def main() -> int:
    ...
    print(f"\nMise à jour carte : {last_update['last_update_label']} ({fetched_at_iso})")
