                ...
                writer.writerow(
                    {
                        ...
                        "wind_speed_10m_kmh": f"{point.wind_speed_kmh:.1f}",
                        "wind_speed_10m_kt": f"{point.wind_speed_kt:.2f}",
                        "wind_gusts_10m_kmh": f"{point.wind_gusts_kmh:.1f}",
                        "wind_gusts_10m_kt": f"{point.wind_gusts_kt:.2f}",
